...
#define LOG_FILES_LENGTH_IN_SECONDS 60
#define LOG_FILES_LENGTH_IN_MB     5
#define GENERATE_MASTER_LOG_FILE     1
#define DURATION_OF_RUN_IN_MINUTES_TO_GENERATE_MASTER_LOG             10
